                                        ...
                                        <tbody>
                                            @foreach ($barangMasuks as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->tanggal_kedaluwarsa->format('d-m-Y') }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            exportPdfBtn.addEventListener('click', function () {
                                ...
                                doc.autoTable({
                                    head: [headers],
                                    body: data,
                                    startY: 60, // Starting Y position
                                    theme: 'striped', // Optional: 'striped', 'grid', 'plain'
                                    headStyles: { fillColor: [41, 128, 185] }, // Example header color
                                    didDrawPage: function (data) {
                                        // Header
                                        doc.setFontSize(16);
                                        doc.text('Laporan Barang Masuk', data.settings.margin.left, 40);
                            ...
                            exportExcelBtn.addEventListener('click', function () {
                                const wb = XLSX.utils.table_to_book(table, { sheet: "Barang Masuk" });
